                                                                        ...
                                                                        <tr>
                                                                            <td class="es-m-p20b esd-container-frame" width="270" align="left">
                                                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="esd-block-image es-m-p0l es-m-txt-c" align="left" style="font-size:0"><a href="https://viewstripo.email" target="_blank"><p style="display: block; color: white; font-size: 30px; font-family: 'Rubik', sans-serif;">devJobs</p></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="esd-container-frame" width="560" valign="top" align="center">
                                                                                <table style="background-position: left top;" width="100%" cellspacing="0" cellpadding="0">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="esd-block-image es-p5t es-p5b" align="center" style="font-size:0"><a target="_blank"><img src="https://dhivcu.stripocdn.email/content/guids/CABINET_dd354a98a803b60e2f0411e893c82f56/images/23891556799905703.png" alt style="display: block;" width="175"></a></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                                                <h1 style="color: #333333; font-size: 20px;"><strong>Verificación de la cuenta</strong></h1>
                                                                                                <h1 style="color: #333333; font-size: 20px;"><strong>&nbsp;</strong></h1>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p40r es-p40l" align="left">
                                                                                                <p style="text-align: center;">Hola,&nbsp;¡Gracias por elegir devJobs! Por favor, confirme su dirección de correo electrónico haciendo clic en el siguiente enlace. Le comunicaremos actualizaciones importantes de vez en cuando por correo electrónico, por lo que es esencial que tengamos una dirección de correo electrónico actualizada en el archivo.</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p25t es-p40r es-p40l" align="center">
                                                                                                <p><b>Si no se registró para obtener una cuenta de devJobs, simplemente puede ignorar este correo electrónico.
                                                                                                </b></p>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l" align="center"><span class="es-button-border"><a href="http://localhost:5000/confirmar-cuenta/${usuario.token}" class="es-button" target="_blank">VERIFIQUE SU DIRECCIÓN DE CORREO ELECTRONICO</a></span></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p15t es-m-txt-c" align="right">
                                                                                                <p style="font-size: 16px; color: #666666;"><strong>Siganos:</strong></p>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="esd-block-social es-p10t es-p5b es-m-txt-c" align="left" style="font-size:0">
                                                                                                <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td class="es-p10r" valign="top" align="center"><a target="_blank" href><img src="https://dhivcu.stripocdn.email/content/assets/img/social-icons/rounded-gray/facebook-rounded-gray.png" alt="Fb" title="Facebook" width="32"></a></td>
                                                                                                            <td class="es-p10r" valign="top" align="center"><a target="_blank" href><img src="https://dhivcu.stripocdn.email/content/assets/img/social-icons/rounded-gray/twitter-rounded-gray.png" alt="Tw" title="Twitter" width="32"></a></td>
                                                                                                            <td class="es-p10r" valign="top" align="center"><a target="_blank" href><img src="https://dhivcu.stripocdn.email/content/assets/img/social-icons/rounded-gray/instagram-rounded-gray.png" alt="Ig" title="Instagram" width="32"></a></td>
                                                                                                            <td class="es-p10r" valign="top" align="center"><a target="_blank" href><img src="https://dhivcu.stripocdn.email/content/assets/img/social-icons/rounded-gray/youtube-rounded-gray.png" alt="Yt" title="Youtube" width="32"></a></td>
                                                                                                            <td class="es-p10r" valign="top" align="center"><a target="_blank" href><img src="https://dhivcu.stripocdn.email/content/assets/img/social-icons/rounded-gray/linkedin-rounded-gray.png" alt="In" title="Linkedin" width="32"></a></td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                            </td>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="esd-block-text" esd-links-color="#666666" align="center">
                                                                                                <p style="font-size: 14px;">Contactanos: <a target="_blank" style="font-size: 14px; color: #666666;" href="tel:123456789">+51 970156009</a> | <a target="_blank" href="mailto:your@mail.com" style="font-size: 14px; color: #666666;">empresa@no-reply.com</a></p>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td esd-links-underline="none" esd-links-color="#ffffff" class="esd-block-text es-p5b" align="left">
                                                                                                <p style="font-size: 14px; color: #ffffff;">Estamos aquí para ayudar, conoce más sobre nosotros <a target="_blank" style="font-size: 14px; color: #FF5733; text-decoration: none;" href="#">aquí</a></p>
                                                                                                <p style="font-size: 14px; color: #ffffff;">o <a target="_blank" style="font-size: 14px; text-decoration: none; color: #ffffff;">contactenos</a><br></p>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
