...
const emailCambioPassword = async(usuario)=>{
    const transport = nodemailer.createTransport({
      ...
      const mailOptions = {
        from: 'devJobs.com',
        to: usuario.email,
        subject: 'Reestablece tu contraseña en devJobs.com',
        text: 'Reestablece tu contraseña en devJobs.com',
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                                                <h1 style="color: #333333; font-size: 20px;"><strong>¿Ha olvidado su contraseña? </strong></h1>
                                                                                                <h1 style="color: #333333; font-size: 20px;"><strong>&nbsp;</strong></h1>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p40r es-p40l" align="left">
                                                                                                <p style="text-align: center;">Hola, ${usuario.nombre}</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l" align="center"><span class="es-button-border"><a href="http://localhost:5000/cambiar-password/${usuario.token}" class="es-button" target="_blank">RESTABLECER CONTRASEÑA</a></span></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
...
export default emailCambioPassword;
